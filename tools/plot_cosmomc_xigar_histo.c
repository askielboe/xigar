...
void PlotParams() {
	...
	TH1F *h6 = new TH1F("h6","Param6: Db",nbins,0.0,1.4);
	TH1F *h7 = new TH1F("h7","Param7: alpha",nbins,-1.0,1.0);
	TH1F *h8 = new TH1F("h8","Param8: beta",nbins,-1.0,1.0);
	...
	while (iline < n) {
		...
		if (likecheck < likecut) {
			...
			h8->Fill(Param8[iline],like[iline]);
	...
	c1->cd(12);
	gr11 = new TGraph2D(n,Param7,Param8,like);
	gr11->SetTitle("Param7 vs Param8: alpha vs beta");

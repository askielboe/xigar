...
INTEGER,PARAMETER			::	N = 6, nbins = 997 ! N = number of shells, nbins = number of bins
...
! do i = 1,nbins
! 	write(1,'(i3, a1, e15.4)') i, ' ', prospec(1,i)
! end do
! close(1)
! 
! open(1,file='prospec2.out',form='formatted')
! do i = 1,nbins
! 	write(1,'(i3, a1, e15.4)') i, ' ', prospec(2,i)
! end do
! close(1)
! 
! open(1,file='prospec6.out',form='formatted')
! do i = 1,nbins
! 	write(1,'(i3, a1, e15.4)') i, ' ', prospec(6,i)
! end do
! close(1)
! 
! open(1,file='prospec6.out',form='formatted')
